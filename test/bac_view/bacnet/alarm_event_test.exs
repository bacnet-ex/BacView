defmodule BacView.BACnet.AlarmEventTest do
  ...
  defp reset_tables! do
    for table <- [:bacview_events, :bacview_notification_log, :bacview_notification_seq] do
      if :ets.whereis(table) != :undefined, do: :ets.delete(table)
    end

    :ets.new(:bacview_events, [:named_table, :set, :public, read_concurrency: true])

    :ets.new(:bacview_notification_log, [
      :named_table,
      :ordered_set,
      :public,
    ...
    :ets.new(:bacview_notification_seq, [:named_table, :set, :public])
  end
